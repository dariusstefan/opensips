...
#### extra_prefix_chars (srt) {#param_extra_prefix_chars}
...
*This flag is deprecated in 3.1+.  The new
						...
						tables.  See the [Dynamic Routing DB schema](https://web.opensips.org/docs/manual/3-1/install-dbschema)
						for more details.*
...
#### is_from_gw([type], [flags], [gw_attrs_pvar], [partition]) {#func_is_from_gw}
...
#### dr_is_gw( sip_uri, [type], [flags], [gw_attrs_pvar], [partition]) {#func_dr_is_gw}
