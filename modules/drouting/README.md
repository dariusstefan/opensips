...
**Example: Set drd_table parameter**
...
**Example: Set drr_table parameter**
...
**Example: Set drg_table parameter**
...
**Example: Set drc_table parameter**
...
**Example: Set ruri_avp parameter**
...
**Example: Set gw_id_avp parameter**
...
**Example: Set gw_priprefix_avp parameter**
...
**Example: Set rule_id_avp parameter**
...
**Example: Set rule_prefix_avp parameter**
...
**Example: Set carrier_id_avp parameter**
...
**Example: Set gw_sock_avp parameter**
...
**Example: Set define_blacklist parameter**
...
**Example: Set default_group parameter**
...
**Example: Set force_dns parameter**
...
**Example: Set probing_socket parameter**
...
**Example: Set gw_socket_filter_mode parameter**
...
**Example: Set drg_user_col parameter**
...
**Example: Set drg_domain_col parameter**
...
**Example: Set drg_grpid_col parameter**
...
**Example: Set partition_id_pvar parameter**
...
**Example: Set extra_id_chars parameter**
...
**Example: route_to_carrier usage**
...
#### drouting:gw_status {#mi_gw_status}
...
**Example: drouting:gw_status usage when use_partitions is set to 0**
...
**Example: drouting:gw_status usage when use_partitionsis set to 1**
...
#### drouting:carrier_status {#mi_carrier_status}
...
**Example: drouting:carrier_status usage when use_partitions is 0**
...
**Example: drouting:carrier_status usage when use_partitions is 1**
...
#### drouting:reload_status {#mi_reload_status}
...
**Example: drouting:reload_status usage when use_partitions is 0**
...
**Example: drouting:reload_status usage when use_partitions is 1**
...
#### drouting:number_routing {#mi_number_routing}
...
#### drouting:enable_probing {#mi_enable_probing}
...
**Example: drouting:enable_probing usage**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 417 | 203 | 13811 | 5825 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 163 | 97 | 2515 | 2613 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 105 | 56 | 1245 | 2282 |
| 4. | Mihai Tiganus ([@tallicamike](https://github.com/tallicamike)) | 73 | 20 | 4301 | 910 |
| 5. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 43 | 20 | 1100 | 735 |
...
**All remaining contributors**: Andrei Dragus, Anca Vamanu, Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Jeremy Martinez ([@JeremyMartinez51](https://github.com/JeremyMartinez51)), wangdd, nexbridge, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), MayamaTakeshi, Matt Lehner, Julián Moreno Patiño, Sergio Gutierrez, mattia, Le Roy Christophe, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Ozzyboshi, Aron Podrigal ([@ar45](https://github.com/ar45)).
