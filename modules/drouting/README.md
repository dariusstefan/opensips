...
#### rule_attrs_avp (str) {#param_rule_attrs_avp}
...
#### status_replication_cluster (integer) {#param_status_replication_cluster}
...
#### do_routing([part_and_or_groupID], [flags], [gw_whitelist], [rule_attrs_pvar], [gw_attrs_pvar], [carrier_attrs_pvar]) {#func_do_routing}
...
#### route_to_carrier(part_and_or_carrier_id, [gw_attrs_pvar], [carrier_attrs_pvar]) {#func_route_to_carrier}
...
#### route_to_gw(gw_id, [gw_attrs_pvar]) {#func_route_to_gw}
...
#### use_next_gw([partition','] [rule_attrs_pvar], [gw_attrs_pvar], [carrier_attrs_pvar])/next_routing() {#func_use_next_gw}
...
#### goes_to_gw([partition','] [type], [flags], [gw_attrs_pvar]) {#func_goes_to_gw}
...
#### is_from_gw([partition','] [type], [flag], [gw_attrs_pvar]) {#func_is_from_gw}
...
#### dr_is_gw([partition,] src_pv, [type], [flag], [gw_attrs_pvar]) {#func_dr_is_gw}
