...
#### db_partitions_url (int) {#param_db_partitions_url}
...
#### db_partitions_table (int) {#param_db_partitions_table}
...
#### enable_restart_persistency (pvar) {#param_enable_restart_persistency}
...
#### route_to_gw(gw_id, [gw_attrs_var], [partition]) {#func_route_to_gw}
...
#### goes_to_gw( [type], [flags], [gw_attrs_pvar], [partition]) {#func_goes_to_gw}
...
#### is_from_gw([type], [flag], [gw_attrs_pvar], [partition]) {#func_is_from_gw}
...
#### dr_is_gw( sip_uri, [type], [flag], [gw_attrs_pvar], [partition]) {#func_dr_is_gw}
