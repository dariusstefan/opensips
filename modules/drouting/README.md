...
**Example: dr_gw_status usage when use_partitions is set to 0**
...
**Example: dr_gw_status usage when use_partitionsis set to 1**
...
**Example: dr_carrier_status usage when use_partitions is 0**
...
**Example: dr_carrier_status usage when use_partitions is 1**
...
**Example: dr_reload_status usage when use_partitions is 0**
...
**Example: dr_reload_status usage when use_partitions is 1**
...
**Example: dr_enable_probing usage**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 406 | 199 | 13728 | 5790 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 155 | 91 | 2502 | 2607 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 99 | 52 | 1170 | 2225 |
| 4. | Mihai Tiganus ([@tallicamike](https://github.com/tallicamike)) | 71 | 20 | 4301 | 910 |
| 5. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 41 | 20 | 1100 | 735 |
| 6. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 23 | 20 | 244 | 47 |
...
**All remaining contributors**: Anca Vamanu, Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Jeremy Martinez ([@JeremyMartinez51](https://github.com/JeremyMartinez51)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Matt Lehner, Julián Moreno Patiño, Sergio Gutierrez, nexbridge, Le Roy Christophe, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Ozzyboshi, Aron Podrigal ([@ar45](https://github.com/ar45)).
...
| --- | --- | --- |
| 1. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Nov 2012 - Dec 2023 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Sep 2010 - Oct 2023 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Oct 2008 - Mar 2023 |
| 4. | nexbridge | Feb 2023 - Feb 2023 |
| 5. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Oct 2020 - Oct 2022 |
| 6. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Mar 2017 - Jul 2022 |
| 7. | Nick Altmann ([@nikbyte](https://github.com/nikbyte)) | Mar 2013 - May 2021 |
| 8. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | May 2014 - Apr 2021 |
| 9. | Aron Podrigal ([@ar45](https://github.com/ar45)) | Nov 2020 - Nov 2020 |
| 10. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Aug 2011 - Nov 2018 |
