...
#### use_struct_param (integer) {#param_use_struct_param}
...
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 9 | 7 | 63 | 31 |
| 3. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 8 | 4 | 199 | 62 |
| 4. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 5 | 3 | 8 | 9 |
| 5. | Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)) | 3 | 1 | 103 | 28 |
| 6. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 3 | 1 | 1 | 1 |
| 7. | Ryan Bullock ([@rrb3942](https://github.com/rrb3942)) | 2 | 1 | 8 | 0 |
...
| --- | --- | --- |
| 1. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Jul 2015 - Jul 2020 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | May 2012 - Jan 2020 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Oct 2014 - Apr 2019 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Oct 2013 - Nov 2018 |
