...
**Example: setting the stat_groups parameter**
...
**Example: setting the stat_series_profile parameter**
...
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 27 | 19 | 518 | 161 |
...
| 6. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 5 | 2 | 144 | 1 |
| 7. | Anca Vamanu | 4 | 2 | 14 | 16 |
| 8. | Henning Westerholt ([@henningw](https://github.com/henningw)) | 4 | 2 | 4 | 4 |
| 9. | Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)) | 3 | 1 | 17 | 1 |
| 10. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | 3 | 1 | 15 | 2 |


**All remaining contributors**: Konstantin Bokarius, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Julián Moreno Patiño, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Edson Gellert Schubert.
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Feb 2012 - Oct 2023 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Mar 2014 - Feb 2023 |
| 3. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Jan 2021 - Jan 2021 |
| 4. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | May 2017 - May 2019 |
| 5. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Mar 2006 - Apr 2019 |
