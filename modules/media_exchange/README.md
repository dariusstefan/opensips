...
The module can both originate calls, pushing an existing SDP to a
		...
		aim of the [OpenSIPS B2B entities module](/modules/b2b_entities).
...
- *Call Recording* - similar to the [OpenSIPS SIPREC](/modules/siprec) module, it can be used to fork the
...
#### media_fork_to_uri(URI[, leg[, headers[, medianum]]]) {#func_media_fork_to_uri}
...
#### media_fork_from_call(callid[, leg[, medianum]]) {#func_media_fork_from_call}
...
#### media_fork_pause([leg[, medianum]]) {#func_media_fork_pause}
...
#### media_fork_resume([leg[, medianum]]) {#func_media_fork_resume}
...
#### media_terminate([leg[, nohold]]) {#func_media_terminate}
...
#### media_fork_from_call_to_uri {#mi_media_fork_from_call_to_uri}
...
#### media_exchange_from_call_to_uri {#mi_media_exchange_from_call_to_uri}
...
#### media_exchange_from_call_to_uri_body {#mi_media_exchange_from_call_to_uri_body}
...
#### media_terminate {#mi_media_terminate}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 163 | 69 | 6236 | 2504 |
| 2. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 6 | 4 | 19 | 11 |
| 3. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 4 | 2 | 12 | 12 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 4 | 2 | 6 | 3 |
| 5. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 3 | 1 | 4 | 4 |
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Feb 2020 - May 2025 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jul 2022 - Jul 2024 |
| 3. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Feb 2023 - Nov 2023 |
| 4. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Mar 2020 - Jul 2021 |
| 5. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Apr 2021 - Apr 2021 |
