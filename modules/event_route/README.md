...
#### fetch_event_params(pvar_list) {#func_fetch_event_params}


Retrieves the parameters of the event. For more information, please 
			read [event route parameters](#event-route-parameters).


The the pseudo variables list as described in [event route parameters](#event-route-parameters).
