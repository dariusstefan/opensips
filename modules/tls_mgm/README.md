...
### Dependencies of external libraries {#dependencies}
...
#### client_domain_avp (integer) {#param_client_domain_avp}


This sets the AVP used for name based TLS client
			domain matching (please see [domains param](#domains-param) for more details). Setting 
