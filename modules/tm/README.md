...
**Example: Set fr_timeout parameter**
...
**Example: Set fr_inv_timeout parameter**
...
**Example: Set wt_timer parameter**
...
**Example: Set delete_timer parameter**
...
**Example: Set T1_timer parameter**
...
**Example: Set T2_timer parameter**
...
**Example: Set ruri_matching parameter**
...
**Example: Set via1_matching parameter**
...
**Example: Set unix_tx_timeout parameter**
...
**Example: Set restart_fr_on_each_reply parameter**
...
**Example: Set tw_append parameter**
...
**Example: Set pass_provisional_replies parameter**
...
**Example: Set syn_branch parameter**
...
**Example: Set onreply_avp_mode parameter**
...
**Example: Set disable_6xx_block parameter**
...
**Example: Set minor_branch_flag parameter**
...
**Example: Set timer_partitions parameter**
...
**Example: Set auto_100trying parameter**
...
Check out the [tm anycast](#tm_anycast) section for more details.


*Anycast replication is disabled by default.*


**Example: Set tm_replication_cluster parameter**
...
**Example: t_wait_no_more_branches usage**
...
**Example: t_add_cancel_reason usage**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 1077 | 627 | 21677 | 16689 |
| 2. | Jiri Kuthan ([@jiriatipteldotorg](https://github.com/jiriatipteldotorg)) | 534 | 198 | 18723 | 11167 |
| 3. | Jan Janak ([@janakj](https://github.com/janakj)) | 160 | 76 | 6462 | 1840 |
| 4. | Andrei Pelinescu-Onciul | 145 | 105 | 2447 | 1210 |
| 5. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 132 | 102 | 1940 | 850 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 107 | 81 | 1242 | 878 |
| 7. | Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)) | 43 | 37 | 322 | 166 |
| 8. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 38 | 16 | 881 | 801 |
| 9. | Anca Vamanu | 37 | 19 | 778 | 651 |
| 10. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 27 | 24 | 172 | 57 |


**All remaining contributors**: Dan Pascu ([@danpascu](https://github.com/danpascu)), Henning Westerholt ([@henningw](https://github.com/henningw)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Juha Heinanen ([@juha-h](https://github.com/juha-h)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Raphael Coeffic, Nils Ohlmeier, Klaus Darilion, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Andreas Granig, Elias Baixas, Marcus Hunger, Christophe Sollet ([@csollet](https://github.com/csollet)), Jeffrey Magder, Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Saúl Ibarra Corretgé ([@saghul](https://github.com/saghul)), Elena-Ramona Modroiu, John Riordan, Julián Moreno Patiño, Andrei Dragus, Jesus Rodrigues, Konstantin Bokarius, Aron Podrigal ([@ar45](https://github.com/ar45)), Anonymous, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Mark Dalby, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Fabian Gast ([@fgast](https://github.com/fgast)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Zero King ([@l2dy](https://github.com/l2dy)), Edson Gellert Schubert, Ingo Wolfsberger, Daniel Hsueh.
