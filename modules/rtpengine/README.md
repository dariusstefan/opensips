...
#### rtpengine_disable_tout (integer) {#rtpengine.p.rtpengine_disable_tout}
...
#### rtpengine_tout (integer) {#rtpengine.p.rtpengine_tout}
...
#### rtpengine_retr (integer) {#rtpengine.p.rtpengine_retr}
...
#### extra_id_pv (string) {#rtpengine.p.extra_id_pv}
...
#### setid_avp (string) {#rtpengine.p.setid_pv}
...
#### rtpengine_offer([flags[, sock_pvar[, sdp_pvar]]]) {#rtpengine.f.rtpengine_offer}
...
#### rtpengine_answer([flags[, sock_pvar[, sdp_pvar]]]) {#rtpengine.f.rtpengine_answer}
...
#### rtpengine_delete([flags[, sock_pvar]]) {#rtpengine.f.rtpengine_delete}
...
#### rtpengine_manage([flags[, sock_pvar[, sdp_pvar]]]) {#rtpengine.f.rtpengine_manage}
...
#### rtpengine_start_recording([sock_pvar]) {#rtpengine.f.start_recording}
...
#### rtpengine_show {#rtpengine.m.rtpengine_show}
