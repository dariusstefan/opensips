...
You can use the [extra failover error](#param_extra_failover_error) parameter
...
#### ping_enabled (integer) {#param_rtpengine_ping_enabled}
...
**Example: Set ping_enabled parameter**
...
##### extra_failover_error (string) {#param_extra_failover_error}
...
**Example: Set extra_failover_error parameter**
...
#### rtpengine_pause_recording([flags [, sock_var]]) {#func_rtpengine_pause_recording}
...
#### rtpengine_stop_media(flags[, [sock_var[, sockvar]], [last_frame_pos]]) {#func_rtpengine_stop_media}
...
**Example: Example of async rtpengine_offer() usage**
...
#### rtpengine_answer([flags[, sock_pvar[, sdp_pvar[, body]]]]) {#afunc_rtpengine_answer}
...
**Example: Example of async rtpengine_answer() usage**
...
#### rtpengine_delete([flags[, sock_var]]) {#afunc_rtpengine_delete}
...
**Example: Example of async rtpengine_delete() usage**
...
**Example: rtpengine:enable usage**
...
**Example: rtpengine:reload usage**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 254 | 146 | 6528 | 3195 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 36 | 21 | 446 | 606 |
| 3. | John Burke ([@john08burke](https://github.com/john08burke)) | 25 | 17 | 647 | 102 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 20 | 16 | 91 | 173 |
| 5. | Richard Fuchs | 20 | 2 | 640 | 723 |
| 6. | Norman Brandinger ([@NormB](https://github.com/NormB)) | 19 | 12 | 703 | 20 |
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 15 | 7 | 218 | 330 |
| 8. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 11 | 8 | 29 | 64 |
| 9. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 8 | 1 | 566 | 94 |
| 10. | Eric Tamme ([@etamme](https://github.com/etamme)) | 7 | 5 | 42 | 19 |


**All remaining contributors**: Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Eddie Fiorentine, Zero King ([@l2dy](https://github.com/l2dy)), Norm Brandinger, Rob Gagnon ([@rgagnon24](https://github.com/rgagnon24)), Flavio E. Goncalves, hatee, Dan Pascu ([@danpascu](https://github.com/danpascu)), Oliver Severin Mulelid-Tynes ([@olivermt](https://github.com/olivermt)), rdondeti, Steven Ayre.
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Jun 2014 - May 2026 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Jun 2014 - Apr 2026 |
| 3. | Norman Brandinger ([@NormB](https://github.com/NormB)) | Jun 2024 - Apr 2026 |
| 4. | rdondeti | Mar 2026 - Mar 2026 |
| 5. | Steven Ayre | Jul 2025 - Jul 2025 |
| 6. | Norm Brandinger | May 2025 - May 2025 |
| 7. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Feb 2025 |
| 8. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Jan 2025 - Jan 2025 |
| 9. | hatee | Dec 2024 - Dec 2024 |
| 10. | Eddie Fiorentine | Nov 2024 - Nov 2024 |


**All remaining contributors**: Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), John Burke ([@john08burke](https://github.com/john08burke)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Flavio E. Goncalves, Zero King ([@l2dy](https://github.com/l2dy)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Oliver Severin Mulelid-Tynes ([@olivermt](https://github.com/olivermt)), Rob Gagnon ([@rgagnon24](https://github.com/rgagnon24)), Eric Tamme ([@etamme](https://github.com/etamme)), Richard Fuchs.
