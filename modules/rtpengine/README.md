...
#### rtpengine_offer([flags[, sock_pvar[, sdp_pvar]]]) {#func_rtpengine_offer}
...
#### rtpengine_answer([flags[, sock_pvar[, sdp_pvar]]]) {#func_rtpengine_answer}
...
#### rtpengine_delete([flags[, sock_pvar]]) {#func_rtpengine_delete}
...
#### rtpengine_manage([flags[, sock_pvar[, sdp_pvar]]]) {#func_rtpengine_manage}
...
#### rtpengine_start_recording([sock_pvar]) {#func_rtpengine_start_recording}
