...
#### append_rpid_hf() {#append-rpid-hf-no-params}
...
#### append_rpid_hf(prefix, suffix) {#append-rpid-hf-params}


This function is the same as 
		[append rpid hf no params](#append-rpid-hf-no-params). The only difference is
