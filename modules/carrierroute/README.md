...
#### cr_user_carrier(user, domain, dstavp) {#func_cr_user_carrier}
...
#### cr_route(carrier, domain, prefix_matching, rewrite_user, hash_source, dstavp) {#func_cr_route}
...
#### cr_prime_route(carrier, domain, prefix_matching, rewrite_user, hash_source, dstavp) {#func_cr_prime_route}
...
#### cr_next_domain(carrier, domain, prefix_matching, host, reply_code, dstavp) {#func_cr_next_domain}
