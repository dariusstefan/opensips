...
#### ds_probing_threshhold (int) {#param_ds_probing_threshhold}
...
#### ds_select_dst(set, alg [, (flags M max_results)*]) {#func_ds_select_dst}
...
#### ds_select_domain(set, alg [, "[flags] [M max_results]"]) {#func_ds_select_domain}
...
#### ds_next_dst([partition_name]) {#func_ds_next_dst}
...
#### ds_next_domain([partition_name]) {#func_ds_next_domain}
...
#### ds_mark_dst() {#func_ds_mark_dst_no_param}
...
#### ds_mark_dst([partition_name], "s") {#func_ds_mark_dst}
...
#### ds_count(set, filter, result) {#func_ds_count}
...
#### ds_is_in_list(ip, port [,set [,active_only]]) {#func_ds_is_in_list}
