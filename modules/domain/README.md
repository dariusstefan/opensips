...
#### is_from_local([attrs_pvar]) {#func_is_from_local}
...
#### is_uri_host_local([attrs_pvar]) {#func_is_uri_host_local}
...
#### is_domain_local(pseudo_variable [, attrs_pvar]) {#func_is_domain_local}
