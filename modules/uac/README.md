...
#### auth_realm_avp (string) {#auth-realm-avp-id}
...
*If you define it, you also need to define 
				"auth_username_avp" 
				([auth username avp id](#auth-username-avp-id)) and 
				"auth_username_avp" 
				([auth password avp id](#auth-password-avp-id)).*
...
#### auth_username_avp (string) {#auth-username-avp-id}
...
*If you define it, you also need to define 
				"auth_realm_avp" 
				([auth realm avp id](#auth-realm-avp-id)) and 
				"auth_username_avp" 
				([auth password avp id](#auth-password-avp-id)).*
...
#### auth_password_avp (string) {#auth-password-avp-id}
...
*If you define it, you also need to define 
				"auth_password_avp" 
				([auth password avp id](#auth-password-avp-id)) and 
				"auth_username_avp" 
				([auth password avp id](#auth-password-avp-id)).*
