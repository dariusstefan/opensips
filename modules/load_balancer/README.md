...
#### lb_start(grp,resources[,flags]) {#func_lb_start}
...
#### lb_start_or_next(grp,resources[,flags]) {#func_lb_start_or_next}
...
#### load_balance(grp,resources[,flags]) {#func_load_balance}
...
#### lb_is_destination(ip,port[,group[,active]]) {#func_lb_is_destination}
