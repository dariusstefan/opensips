...
**Example: Set rlsubs_table parameter**
...
**Example: Set rlpres_table parameter**
...
**Example: Set waitn_time parameter**
...
**Example: Set to_presence_code parameter**
...
**Example: Set rls_event parameter**
...
| 2. | Saúl Ibarra Corretgé ([@saghul](https://github.com/saghul)) | 40 | 18 | 1150 | 710 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 25 | 21 | 110 | 137 |
| 4. | Dan Pascu ([@danpascu](https://github.com/danpascu)) | 15 | 10 | 127 | 138 |
| 5. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 14 | 12 | 20 | 38 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 13 | 10 | 58 | 77 |
| 7. | Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)) | 9 | 7 | 18 | 15 |
| 8. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 7 | 5 | 28 | 35 |
| 9. | Henning Westerholt ([@henningw](https://github.com/henningw)) | 7 | 3 | 164 | 114 |
| 10. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 5 | 3 | 11 | 41 |


**All remaining contributors**: Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Stanislaw Pitucha, Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Sergio Gutierrez, Konstantin Bokarius, UnixDev, John Riordan, Julián Moreno Patiño, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Edson Gellert Schubert.
...
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Jan 2008 - Mar 2020 |
| 3. | Dan Pascu ([@danpascu](https://github.com/danpascu)) | Aug 2008 - Jul 2019 |
...
| 9. | Saúl Ibarra Corretgé ([@saghul](https://github.com/saghul)) | Oct 2012 - Jan 2013 |
| 10. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Aug 2011 - Mar 2012 |


**All remaining contributors**: Anca Vamanu, Stanislaw Pitucha, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), John Riordan, UnixDev, Sergio Gutierrez, Henning Westerholt ([@henningw](https://github.com/henningw)), Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert.
