...
#### get_glob_headers_values(hdr_name_glob, hdr_names_avp,hdr_vals_avp) {#get_glob_headers_values}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 71 | 41 | 2130 | 721 |
...
| 4. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 15 | 7 | 530 | 123 |
| 5. | David Trihy | 7 | 3 | 132 | 74 |
| 6. | Mihai Tiganus ([@tallicamike](https://github.com/tallicamike)) | 6 | 3 | 155 | 28 |
| 7. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 5 | 3 | 2 | 3 |
| 8. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 4 | 2 | 49 | 13 |
| 9. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | 4 | 2 | 22 | 1 |
| 10. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 4 | 2 | 2 | 2 |


**All remaining contributors**: Boris Ratner, Julián Moreno Patiño, Fabian Gast ([@fgast](https://github.com/fgast)), Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Dan Pascu ([@danpascu](https://github.com/danpascu)).
...
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Feb 2012 - Mar 2025 |
| 3. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Feb 2012 - Jun 2023 |
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Feb 2012 - Jun 2023 |
| 5. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Mar 2021 - Feb 2023 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Nov 2012 - Oct 2022 |
