...
#### append_to_reply(txt) {#func_append_to_reply}
...
#### append_body_to_reply(txt) {#func_append_body_to_reply}
...
#### append_hf(txt[, hdr_anchor]) {#func_append_hf}
...
#### insert_hf(txt, hdr) {#func_insert_hf_2}
...
#### append_urihf(prefix, suffix) {#func_append_urihf}
...
#### is_present_hf(hf_name) {#func_is_present_hf}
...
#### remove_hf(hname) {#func_remove_hf}
...
#### remove_hf_re(hname_expr) {#func_remove_hf_re}
...
#### remove_hf_glob(hname_pattern) {#func_remove_hf_glob}
...
#### ruri_has_param(param[,value]) {#func_ruri_has_param}
...
#### ruri_add_param(param) {#func_ruri_add_param}
...
#### ruri_del_param(param) {#func_ruri_del_param}
...
#### ruri_tel2sip() {#func_ruri_tel2sip}
...
#### is_uri_user_e164(uri) {#func_is_uri_user_e164}
...
#### has_body_part([mime]) {#func_has_body_part}
...
#### is_audio_on_hold() {#func_is_audio_on_hold}
...
#### is_privacy(privacy_type) {#func_is_privacy}
...
#### remove_body_part([mime[, revert]]) {#func_remove_body_part}
...
#### add_body_part(body, mime[, headers]) {#func_add_body_part}
...
#### get_updated_body_part( [mime], variable) {#func_get_updated_body_part}
...
#### sipmsg_validate([flags[, result_pvar]]) {#func_sipmsg_validate}
...
#### codec_exists (name[, clock]) {#func_codec_exists}
...
#### codec_delete(name[, clock]) {#func_codec_delete}
...
#### codec_move_up(name[, clock]) {#func_codec_move_up}
...
#### codec_move_down(name[, clock]) {#func_codec_move_down}
...
#### codec_exists_re ( regexp ) {#func_codec_exists_re}
...
#### codec_delete_re ( regexp ) {#func_codec_delete_re}
...
#### codec_delete_except_re ( regexp ) {#func_codec_delete_except_re}
...
#### codec_move_up_re ( regexp ) {#func_codec_move_up_re}
...
#### codec_move_down_re ( regexp ) {#func_codec_move_down_re}
...
#### change_reply_status(code, reason) {#change_reply_status}
...
#### stream_exists(regexp[,regexp2]) {#func_stream_exists}
...
#### stream_delete(regexp[,regexp2]) {#func_stream_delete}
...
#### list_hdr_has_option(hdr_name, option) {#func_list_hdr_has_option}
...
#### list_hdr_add_option(hdr_name, option) {#func_list_hdr_add_option}
...
#### list_hdr_remove_option(hdr_name, option) {#func_list_hdr_remove_option}
...
#### get_glob_headers_values(hdr_name_glob, hdr_names_avp,hdr_vals_avp) {#func_get_glob_headers_values}
...
#### sip_to_json(out_var) {#func_sip_to_json}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 77 | 44 | 2294 | 762 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 62 | 28 | 876 | 1544 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 48 | 21 | 2956 | 120 |
| 4. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 17 | 8 | 663 | 123 |
| 5. | Mihai Tiganus ([@tallicamike](https://github.com/tallicamike)) | 6 | 3 | 155 | 28 |
| 6. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 5 | 3 | 2 | 3 |
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 4 | 2 | 49 | 13 |
| 8. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | 4 | 2 | 22 | 1 |
| 9. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 4 | 2 | 2 | 2 |
| 10. | Boris Ratner | 4 | 1 | 129 | 46 |


**All remaining contributors**: Bence Szigeti, Julián Moreno Patiño, Fabian Gast ([@fgast](https://github.com/fgast)), Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Ubuntu, Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Tristan, Dan Pascu ([@danpascu](https://github.com/danpascu)).
...
| --- | --- | --- |
| 1. | Tristan | May 2026 - May 2026 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Feb 2012 - Jan 2026 |
| 3. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Nov 2012 - Dec 2025 |
| 4. | Ubuntu | Mar 2025 - Mar 2025 |
| 5. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Feb 2012 - Jul 2024 |
| 6. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Feb 2012 - May 2024 |
| 7. | Bence Szigeti | May 2023 - May 2023 |
| 8. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Mar 2021 - Feb 2023 |
