...
## The Sip Express Application Server User's Guide {#user}
...
#### Application Servers {#ApplicationServer}
...
##### listen_sockets (string) {#param_listen_sockets}
...
##### as_relay_t(String name) {#func_as_relay_t}
