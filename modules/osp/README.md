...
**Example: Instructing the module to work in direct mode**
...
#### service_type {#param_service_type}
...
**Example: Instructing the module to provide normal voice service**
...
#### sp1_uri, sp2_uri, ..., sp16_uri {#param_sp1_uri}
...
**Example: Setting the OSP servers**
...
#### sp1_weight, sp2_weight, ..., sp16_weight {#param_sp1_weight}
...
**Example: Setting the OSP server weights**
...
**Example: Setting the device IP address**
...
#### use_security_features {#param_use_security_features}
...
**Example: Instructing the module not to use OSP security features**
...
#### token_format {#param_token_format}
...
**Example: Setting the token format**
...
#### private_key, local_certificate, ca_certificates {#param_private_key}
...
**Example: Set authorization files**
...
#### enable_crypto_hardware_support {#param_enable_crypto_hardware_support}
...
**Example: Setting the hardware support**
...
#### ssl_lifetime {#param_ssl_lifetime}
...
**Example: Setting the ssl lifetime**
...
**Example: Setting the persistence**
...
**Example: Setting the retry delay**
...
**Example: Setting the retry limit**
...
#### support_nonsip_protocol {#param_support_nonsip_protocol}
...
**Example: Setting support non-SIP destination devices**
...
#### max_destinations {#param_max_destinations}
...
**Example: Setting the number of destination**
...
#### report_networkid {#param_report_networkid}
...
**Example: Setting report network ID flag**
...
#### validate_call_id {#param_validate_call_id}
...
**Example: Instructing the module to validate call id**
...
#### use_number_portability {#param_use_number_portability}
...
**Example: Instructing the module to use number portability parameters in Request URI**
...
#### append_userphone {#param_append_userphone}
...
**Example: Append user=phone parameter**
...
#### networkid_location {#param_networkid_location}
...
**Example: Append networkid location**
...
#### networkid_parameter {#param_networkid_parameter}
...
**Example: Networkid parameter name**
...
#### switchid_location {#param_switchid_location}
...
**Example: Append switchid location**
...
#### switchid_parameter {#param_switchid_parameter}
...
#### parameterstring_location {#param_parameterstring_location}
...
**Example: Append parameter string location**
...
#### parameterstring_value {#param_parameterstring_value}
...
#### source_device_avp {#param_source_device_avp}
...
**Example: Setting the source device IP AVP**
...
#### source_networkid_avp {#param_source_networkid_avp}
...
**Example: Setting the source network ID AVP**
...
#### source_switchid_avp {#param_source_switchid_avp}
...
**Example: Setting the source switch ID AVP**
...
#### custom_info_avp {#param_custom_info_avp}
...
**Example: Setting the custom info AVP**
...
#### extraheaders_value {#param_extraheaders_value}
...
**Example: Setting the NOTIFY extra headers**
...
#### source_media_avp, destination_media_avp {#param_source_media_avp, destination_media_avp}
...
**Example: Setting the media address AVPs**
...
#### request_date_avp {#param_request_date_avp}
...
**Example: Setting the request date AVP**
...
#### sdp_fingerprint_avp {#param_sdp_fingerprint_avp}
...
**Example: Setting the SDP finger print AVP**
...
#### identity_signature_avp, identity_algorithm_avp, identity_information_avp, identity_type_avp, identity_canon_avp {#param_identity_signature_avp}
...
**Example: Setting the Identity related AVPs**
...
#### service_provider_avp {#param_service_provider_avp}
...
**Example: Setting the source service provider AVP**
...
#### user_group_avp {#param_user_group_avp}
...
**Example: Setting the source user group AVP**
...
**Example: Setting the source user ID AVP**
...
#### checkospheader() {#func_checkospheader}
...
#### validateospheader() {#func_validateospheader}
...
#### getlocaladdress() {#func_getlocaladdress}
...
#### setrequestdate() {#func_setrequestdate}
...
#### requestosprouting() {#func_requestosprouting}
...
#### checkosproute() {#func_checkosproute}
...
#### prepareosproute() {#func_prepareosproute}
...
#### prepareospresponse() {#func_prepareospresponse}
...
#### prepareallosproutes() {#func_prepareallosproutes}
...
#### checkcallingtranslation() {#func_checkcallingtranslation}
...
#### reportospusage() {#func_reportospusage}
...
#### processsubscribe([cachedcnamrecord]) {#func_processsubscribe}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Di-Shi Sun ([@di-shi](https://github.com/di-shi)) | 274 | 101 | 10368 | 5372 |
| 2. | Dmitry Isakbayev | 42 | 5 | 4120 | 159 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 33 | 27 | 220 | 211 |
| 4. | Di-Shi Sun | 18 | 2 | 1006 | 386 |
| 5. | Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)) | 15 | 13 | 81 | 48 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 15 | 12 | 83 | 92 |
| 7. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 11 | 9 | 75 | 54 |
| 8. | Zero King ([@l2dy](https://github.com/l2dy)) | 10 | 8 | 20 | 23 |
| 9. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 9 | 6 | 68 | 65 |
| 10. | Ancuta Onofrei | 9 | 1 | 206 | 318 |


**All remaining contributors**: Dan Pascu ([@danpascu](https://github.com/danpascu)), Henning Westerholt ([@henningw](https://github.com/henningw)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Konstantin Bokarius, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), fabriziopicconi, Andreas Granig, Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Julián Moreno Patiño, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Ralf Zerres, Edson Gellert Schubert.
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Jun 2011 - Jan 2021 |
| 2. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Sep 2020 - Sep 2020 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Jan 2006 - Apr 2020 |
| 4. | Zero King ([@l2dy](https://github.com/l2dy)) | Mar 2020 - Mar 2020 |
| 5. | Dan Pascu ([@danpascu](https://github.com/danpascu)) | Nov 2008 - Jul 2019 |
| 6. | Ralf Zerres | May 2019 - May 2019 |
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | May 2017 - Apr 2019 |
| 8. | Di-Shi Sun | Oct 2018 - Feb 2019 |
| 9. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Mar 2014 - Dec 2018 |
| 10. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Jun 2018 |


**All remaining contributors**: Di-Shi Sun ([@di-shi](https://github.com/di-shi)), Julián Moreno Patiño, Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), fabriziopicconi, Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Henning Westerholt ([@henningw](https://github.com/henningw)), Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert, Ancuta Onofrei, Dmitry Isakbayev, Andreas Granig.
