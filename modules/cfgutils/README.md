...
#### set_count(pvar name, result pvar name) {#func_set_count}
...
#### set_select_weight(pseudovarible_name) {#func_set_select_weight}
...
#### check_time_rec(time_string) {#func_check_time_rec}
...
#### get_static_lock(string) {#func_get_static_lock}
...
#### release_static_lock(string) {#func_release_static_lock}
...
#### get_dynamic_lock(string) {#func_get_dynamic_lock}
...
#### release_dynamic_lock(string) {#func_release_dynamic_lock}
...
#### strings_share_lock(string1, string2) {#func_strings_share_lock}
