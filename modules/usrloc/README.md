...
Using the *req_callid*, if a dialog has been
				...
				[load_dialog_ctx()](/modules/dialog#func_load_dialog_ctx) and
				[unload_dialog_ctx()](/modules/dialog#func_unload_dialog_ctx)
...
| --- | --- | --- | --- | --- | --- |
| 1. | Jan Janak ([@janakj](https://github.com/janakj)) | 410 | 117 | 15689 | 10095 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 336 | 200 | 9164 | 3701 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 245 | 150 | 4232 | 3624 |
| 4. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 42 | 24 | 790 | 657 |
| 5. | Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)) | 40 | 29 | 544 | 308 |
| 6. | Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)) | 40 | 24 | 1099 | 413 |
| 7. | Jiri Kuthan ([@jiriatipteldotorg](https://github.com/jiriatipteldotorg)) | 35 | 25 | 975 | 120 |
| 8. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 30 | 23 | 386 | 141 |
| 9. | Henning Westerholt ([@henningw](https://github.com/henningw)) | 21 | 11 | 462 | 356 |
| 10. | Andrei Pelinescu-Onciul | 17 | 13 | 151 | 91 |


**All remaining contributors**: Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Nils Ohlmeier, Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Andrei Dragus, Anca Vamanu, Alessio Garzi ([@Ozzyboshi](https://github.com/Ozzyboshi)), Zero King ([@l2dy](https://github.com/l2dy)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Andrei Datcu ([@andrei-datcu](https://github.com/andrei-datcu)), Juha Heinanen ([@juha-h](https://github.com/juha-h)), Marcus Hunger, Jamey Hicks, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Andreas Granig, Shlomi Gutman, [@jalung](https://github.com/jalung), Jeffrey Magder, Phil D'Amore, Norman Brandinger ([@NormB](https://github.com/NormB)), David Sanders, Konstantin Bokarius, Klaus Darilion, Iouri Kharon, Aron Podrigal ([@ar45](https://github.com/ar45)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Matthew M. Boedicker, UnixDev, Edson Gellert Schubert, Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Elena-Ramona Modroiu, Stephane Alnet.
...
| --- | --- | --- |
| 1. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jan 2013 - Nov 2023 |
| 2. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Jun 2011 - Jul 2023 |
| 3. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Jul 2016 - Jul 2022 |
| 4. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Mar 2002 - Feb 2022 |
| 5. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Jul 2011 - Nov 2021 |
| 6. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | Apr 2019 - May 2021 |
| 7. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Apr 2003 - Feb 2021 |
| 8. | Zero King ([@l2dy](https://github.com/l2dy)) | Mar 2020 - Mar 2020 |
| 9. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Feb 2020 |
| 10. | Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)) | Dec 2019 - Dec 2019 |
