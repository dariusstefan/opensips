...
#### acc_function (string) {#param_acc_function}
...
#### acc_db_table (string) {#param_acc_db_table}
...
#### get_redirects(max) {#func_get_redirects}
...
#### get_redirects(max,reason) {#func_get_redirects_2}
