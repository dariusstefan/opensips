...
#### networks (string) {#param_networks}
...
#### default_net (string) {#param_default_net}
...
#### max_sms_parts (integer) {#param_max_sms_parts}
...
#### use_contact (integer) {#param_use_contact}
...
#### sms_report_type (integer) {#param_sms_report_type}
...
#### sms_send_msg_to_net(network_name) {#func_sms_send_msg_to_net}
...
#### sms_send_msg() {#func_sms_send_msg}
