...
#### exec_dset(command) (DEPRECATED) {#func_exec_dset}
...
#### exec_msg(command) (DEPRECATED) {#func_exec_msg}
...
#### exec_avp(command[, avplist]) (DEPRECATED) {#func_exec_avp}
...
#### exec_getenv(environment_variable[, avp]) (DEPRECATED) {#func_exec_getenv}
