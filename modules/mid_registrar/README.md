...
In "contact mirroring" mode, the mid-registrar will only insert itself
		...
		[sip flow insertion](#sip-flow-insertion) for a detailed description of
...
Only relevant in a "mirroring" or "contact throttling"
		...
		[sip flow insertion](#sip-flow-insertion) for more details.
...
#### mid_registrar_save(domain[, [flags][, [aor][, [outgoing_expires]]]]) {#func_mid_registrar_save}
