...
**Example: Setting the *mode* module parameter**
...
**Example: Setting the *contact_id_insertion* module parameter**
...
**Example: Setting the *contact_id_param* module parameter**
...
Only relevant when in "AoR throttling" [mode](#param_mode)
			and with the usrloc [use_domain](/modules/usrloc#param_use_domain)
...
**Example: Setting the *at_escape_str* module parameter**
...
**Example: Setting the *outgoing_expires* module parameter**
...
**Example: Setting the *received_avp* module parameter**
...
**Example: Setting the *received_param* module parameter**
...
**Example: Setting the *extra_contact_params_avp* module parameter**
...
**Example: Setting the *min_expires* module parameter**
...
**Example: Setting the *default_expires* module parameter**
...
**Example: Setting the *max_expires* module parameter**
...
**Example: Setting the *default_q* module parameter**
...
**Example: Setting the *tcp_persistent_flag* module parameter**
...
**Example: Setting the *realm_prefix* module parameter**
...
**Example: Setting the *case_sensitive* module parameter**
...
**Example: Setting the *max_username_len* module parameter**
...
**Example: Setting the *max_domain_len* module parameter**
...
**Example: Setting the *max_aor_len* module parameter**
...
**Example: Setting the *max_contact_len* module parameter**
...
**Example: Setting the *retry_after* module parameter**
...
**Example: Setting the *gruu_secret* module parameter**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 507 | 203 | 16332 | 10230 |
| 2. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 14 | 7 | 127 | 248 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 10 | 7 | 103 | 111 |
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 9 | 7 | 23 | 18 |
| 5. | Chad Attermann ([@attermann](https://github.com/attermann)) | 7 | 5 | 19 | 5 |
| 6. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 5 | 3 | 14 | 14 |
| 7. | Dan Pascu ([@danpascu](https://github.com/danpascu)) | 4 | 2 | 4 | 4 |
| 8. | Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)) | 3 | 1 | 2 | 5 |
| 9. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 3 | 1 | 1 | 1 |
| 10. | Italo Rossi ([@italorossi](https://github.com/italorossi)) | 2 | 1 | 6 | 0 |
...
| --- | --- | --- |
| 1. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jul 2016 - May 2024 |
...
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Mar 2017 - Jan 2023 |
| 5. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Apr 2017 - Feb 2022 |
| 6. | Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)) | Jan 2022 - Jan 2022 |
| 7. | Dan Pascu ([@danpascu](https://github.com/danpascu)) | May 2019 - May 2019 |
| 8. | Italo Rossi ([@italorossi](https://github.com/italorossi)) | Jul 2018 - Jul 2018 |
| 9. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Jun 2018 |
| 10. | Chad Attermann ([@attermann](https://github.com/attermann)) | Jun 2017 - Jul 2017 |
