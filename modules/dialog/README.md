...
#### load_dialog_ctx( dialog [, id_type]) {#func_load_dialog_ctx}
...
#### set_dlg_profile(profile,[value]) {#func_set_dlg_profile}
...
#### set_dlg_flag(idx) {#func_set_dlg_flag}
...
#### test_and_set_dlg_flag(idx, value) {#func_test_and_set_dlg_flag}
...
#### reset_dlg_flag(idx) {#func_reset_dlg_flag}
...
#### is_dlg_flag_set(idx) {#func_is_dlg_flag_set}
...
#### profile_get_size {#mi_profile_get_size}
...
#### profile_list_dlgs {#mi_profile_list_dlgs}
...
#### profile_get_values {#mi_profile_get_values}
...
#### profile_end_dlgs {#mi_profile_end_dlgs}
...
#### dlg_cluster_sync {#mi_dlg_cluster_sync}
...
#### dlg_restore_db {#mi_dlg_restore_db}
...
#### list_all_profiles {#mi_list_all_profiles}
...
#### dlg_send_sequential {#mi_dlg_send_sequential}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 443 | 282 | 12853 | 3426 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 274 | 206 | 5086 | 1560 |
| 3. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 254 | 145 | 7206 | 3027 |
| 4. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 185 | 99 | 3831 | 3269 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 168 | 123 | 2895 | 1243 |
| 6. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | 35 | 26 | 638 | 158 |
| 7. | Dan Pascu ([@danpascu](https://github.com/danpascu)) | 30 | 25 | 233 | 179 |
| 8. | Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)) | 18 | 6 | 722 | 341 |
...
**All remaining contributors**: Anca Vamanu, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Andrei Dragus, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), John Riordan, Hugues Mitonneau, Carsten Bock, Jerome Martin, Klaus Darilion, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Zero King ([@l2dy](https://github.com/l2dy)), Michel Bensoussan, Richard Revels, Elena-Ramona Modroiu, Tavis Paquette, Andrei Datcu ([@andrei-datcu](https://github.com/andrei-datcu)), Jeffrey Magder, Ron Winacott, Andy Pyles, Julián Moreno Patiño, Konstantin Bokarius, sergei lavrov, Alex Massover, Damien Sandras ([@dsandras](https://github.com/dsandras)), Alex Hermann, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Norman Brandinger ([@NormB](https://github.com/NormB)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), UnixDev, Eliot Gable, Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Edson Gellert Schubert.
...
| --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Apr 2006 - Dec 2023 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Aug 2012 - Nov 2023 |
| 3. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Oct 2010 - Nov 2023 |
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Aug 2010 - Oct 2023 |
| 5. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | Feb 2008 - Jun 2023 |
| 6. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Jul 2016 - Jul 2022 |
| 7. | Nick Altmann ([@nikbyte](https://github.com/nikbyte)) | Oct 2013 - May 2021 |
| 8. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | Apr 2010 - Apr 2021 |
| 9. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Nov 2020 - Jan 2021 |
| 10. | sergei lavrov | Dec 2020 - Dec 2020 |


**All remaining contributors**: Zero King ([@l2dy](https://github.com/l2dy)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Julián Moreno Patiño, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)), Andrei Datcu ([@andrei-datcu](https://github.com/andrei-datcu)), Norman Brandinger ([@NormB](https://github.com/NormB)), Damien Sandras ([@dsandras](https://github.com/dsandras)), Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Anca Vamanu, Alex Massover, Andrei Dragus, John Riordan, Hugues Mitonneau, Richard Revels, UnixDev, Alex Hermann, Henning Westerholt ([@henningw](https://github.com/henningw)), Carsten Bock, Klaus Darilion, Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert, Jerome Martin, Tavis Paquette, Michel Bensoussan, Eliot Gable, Andy Pyles, Elena-Ramona Modroiu, Jeffrey Magder, Ron Winacott.
