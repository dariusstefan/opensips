...
#### dlg_sharing_tag (string) {#param_dlg_sharing_tag}
...
#### create_dialog() {#func_create_dialog}
...
#### get_dialog_info(attr,var,key,key_val) {#func_get_dialog_info}
...
#### fetch_dlg_value(name,pvar) {#func_fetch_dlg_value}
...
#### dlg_set_sharing_tag_active {#mi_dlg_set_sharing_tag_active}
...
#### dlg_list_sharing_tags {#mi_dlg_list_sharing_tags}


Lists all known sharing tags and their states.


For more details on sharing tags see the [dialog clustering](#dialog-clustering) chapter.
