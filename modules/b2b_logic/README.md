...
#### use_init_sdp (int) {#param_use_init_sdp}
...
#### b2b_init_request(id, [flags], [req_route],
			[reply_route], [init_sdp_body], [init_sdp_ctype]) {#func_b2b_init_request}
...
#### b2b_handle_reply() {#func_b2b_handle_reply}
...
#### b2b_bridge_request(b2bl_key,entity_no, [adv_contact]) {#func_b2b_bridge_request}
...
#### b2b_trigger_scenario {#mi_b2b_trigger_scenario}
...
#### b2b_terminate_call {#mi_b2b_terminate_call}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 124 | 43 | 3885 | 2950 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 22 | 13 | 596 | 227 |
| 3. | Nick Altmann ([@nikbyte](https://github.com/nikbyte)) | 13 | 9 | 278 | 29 |
| 4. | Carsten Bock | 12 | 5 | 679 | 23 |
| 5. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 7 | 5 | 66 | 18 |
| 6. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 4 | 2 | 21 | 21 |
| 7. | truong.hua | 4 | 2 | 8 | 7 |
| 8. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 4 | 2 | 3 | 2 |
| 9. | Aron Podrigal ([@ar45](https://github.com/ar45)) | 3 | 1 | 1 | 1 |
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Jan 2021 - Dec 2023 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Apr 2021 - Dec 2023 |
| 3. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Nov 2020 - Jul 2023 |
| 4. | truong.hua | Jan 2023 - Feb 2023 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Nov 2020 - Nov 2022 |
| 6. | Carsten Bock | Mar 2022 - Apr 2022 |
| 7. | Aron Podrigal ([@ar45](https://github.com/ar45)) | Nov 2021 - Nov 2021 |
| 8. | Nick Altmann ([@nikbyte](https://github.com/nikbyte)) | Feb 2021 - May 2021 |
| 9. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Jan 2021 - Jan 2021 |
| 10. | Zero King ([@l2dy](https://github.com/l2dy)) | Dec 2020 - Dec 2020 |
