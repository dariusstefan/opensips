...
#### script_scenario (str) {#param_script_scenario}
...
#### extern_scenario (str) {#param_extern_scenario}
...
#### b2b_init_request(flags, [scenario_param1], [scenario_param2], [scenario_param3], [scenario_param4]) {#func_b2b_init_request}
...
#### b2b_bridge_request(b2bl_key,entity_no) {#func_b2b_bridge_request}
