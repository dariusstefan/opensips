...
#### use_sip_uri_host (integer) {#param_use_sip_uri_host}
...
#### uriuser_column (string) {#param_uriuser_column}
...
#### use_uri_table (integer) {#param_use_uri_table}
...
#### db_check_from() {#func_db_check_from}
...
#### db_does_uri_exist() {#func_db_does_uri_exist}
...
#### db_get_auth_id(string, var, var) {#func_db_get_auth_id}
...
#### aaa_does_uri_exist([pvar]) {#func_aaa_does_uri_exist}
...
#### aaa_does_uri_user_exist([pvar]) {#func_aaa_does_uri_user_exist}
...
#### uri_param(param) {#func_uri_param}
...
#### uri_param(param,value) {#func_uri_param_2}
...
#### add_uri_param(param) {#func_add_uri_param}
...
#### del_uri_param(param) {#func_del_uri_param}
...
#### is_uri_user_e164(pseudo-variable) {#func_is_uri_user_e164}
