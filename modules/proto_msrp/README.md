...
This controls whether tracing for MSRP is on or not. You still need
		to define [trace destination](#trace-destination)in order to work, but
...
Define the name of a route in which you can filter which connections will
			...
			have to define a [trace destination](#trace-destination) and trace must be
...
**WARNING:** IF [trace on](#trace-on) is
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 67 | 17 | 4831 | 525 |
| 2. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 32 | 22 | 422 | 348 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 22 | 17 | 191 | 122 |
| 4. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 6 | 4 | 30 | 28 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 6 | 4 | 23 | 21 |
| 6. | Jason Shugart | 3 | 1 | 4 | 3 |
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Sep 2022 - Mar 2026 |
| 2. | Jason Shugart | Sep 2025 - Sep 2025 |
| 3. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Feb 2023 - Nov 2023 |
| 4. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Mar 2022 - May 2023 |
| 5. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Mar 2022 - Jul 2022 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Apr 2022 - Jul 2022 |
