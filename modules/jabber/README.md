...
**Example: Set jaddress parameter**
...
**Example: Set registrar parameter**
...
**Example: Set max_jobs parameter**
...
**Example: Set cache_time parameter**
...
**Example: Set delay_time parameter**
...
**Example: Set sleep_time parameter**
...
**Example: Set check_time parameter**
...
**Example: Set priority parameter**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)) | 374 | 80 | 19649 | 8172 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 55 | 33 | 1383 | 558 |
| 3. | Jan Janak ([@janakj](https://github.com/janakj)) | 33 | 15 | 1007 | 498 |
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 22 | 20 | 70 | 50 |
| 5. | Andrei Pelinescu-Onciul | 19 | 12 | 101 | 336 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 12 | 9 | 45 | 107 |
| 7. | Jiri Kuthan ([@jiriatipteldotorg](https://github.com/jiriatipteldotorg)) | 6 | 3 | 313 | 0 |
| 8. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 5 | 3 | 31 | 9 |
| 9. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 4 | 2 | 33 | 8 |
| 10. | Henning Westerholt ([@henningw](https://github.com/henningw)) | 4 | 2 | 29 | 23 |


**All remaining contributors**: Elena-Ramona Modroiu, Jamey Hicks, Konstantin Bokarius, John Riordan, Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Julián Moreno Patiño, Klaus Darilion, Zero King ([@l2dy](https://github.com/l2dy)), Edson Gellert Schubert, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)).
...
| --- | --- | --- |
| 1. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Oct 2022 - Oct 2022 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Mar 2014 - Jul 2021 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Aug 2015 - Jul 2020 |
| 4. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Jun 2002 - Apr 2020 |
...
| 7. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | May 2007 - Jun 2018 |
| 8. | Julián Moreno Patiño | Feb 2016 - Feb 2016 |
| 9. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Feb 2012 - Feb 2012 |
