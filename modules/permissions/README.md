...
#### allow_routing(allow_file,deny_file) {#func_allow_routing_2}


Returns true if all pairs constructed as described in
		[sec call routing](#sec-call-routing) have appropriate permissions
...
#### allow_register(allow_file, deny_file) {#func_allow_register_2}


The function returns true if all pairs constructed as described in
		[sec registration permissions](#sec-registration-permissions) have appropriate
...
#### allow_uri(basename, pvar) {#func_allow_uri}
...
#### check_address([partition:]group_id, ip, port, proto [, context_info [, pattern]]) {#func_check_address}
...
#### check_source_address(group_id [, context_info [, pattern]]) {#func_check_source_address}
...
#### get_source_group(pvar) {#func_get_source_group}
