...
**Example: Set acc_db_url parameter**
...
**Example: Set rt_db_url parameter**
...
**Example: Set wrapup_time parameter**
...
**Example: Set queue_pos_param parameter**
...
**Example: Set reject_on_no_agents parameter**
...
**Example: Set chat_dispatch_policy parameter**
...
**Example: Set internal_call_dispatching parameter**
...
**Example: Set cc_agents_table parameter**
...
**Example: Set cca_agentid_column parameter**
...
**Example: Set cca_location_column parameter**
...
**Example: Set cca_msrp_location_column parameter**
...
**Example: Set cca_msrp_max_sessions_column parameter**
...
**Example: Set cca_skills_column parameter**
...
**Example: Set cca_logstate_column parameter**
...
**Example: Set cca_wrapuptime_column parameter**
...
**Example: Set cca_wrapupend_column parameter**
...
**Example: Set cc_flows_table parameter**
...
**Example: Set ccf_flowid_column parameter**
...
**Example: Set ccf_priority_column parameter**
...
**Example: Set ccf_skill_column parameter**
...
**Example: Set ccf_cid_column parameter**
...
**Example: Set ccf_max_wrapup_column parameter**
...
**Example: Set ccf_dissuading_hangup_column parameter**
...
**Example: Set ccf_dissuading_onhold_th_column parameter**
...
**Example: Set ccf_dissuading_ewt_th_column parameter**
...
**Example: Set ccf_dissuading_qsize_th_column parameter**
...
**Example: Set ccf_m_welcome_column parameter**
...
**Example: Set ccf_m_queue_column parameter**
...
**Example: Set ccf_m_dissuading_column parameter**
...
**Example: Set ccf_m_flow_id_column parameter**
...
#### cc_agent_login {#mi_cc_agent_login}
...
#### cc_list_queue {#mi_cc_list_queue}
...
#### cc_list_flows {#mi_cc_list_flows}
...
#### cc_list_agents {#mi_cc_list_agents}
...
#### cc_list_calls {#mi_cc_list_calls}
...
#### cc_dispatch_call_to_agent {#mi_cc_dispatch_call_to_agent}
...
#### cc_internal_call_dispatching {#mi_cc_internal_call_dispatching}
...
#### cc_reset_stats {#mi_cc_reset_stats}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 109 | 44 | 6780 | 511 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 43 | 33 | 796 | 159 |
| 3. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 18 | 9 | 287 | 314 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 14 | 11 | 72 | 89 |
| 5. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | 4 | 2 | 1 | 2 |
| 6. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 4 | 2 | 1 | 1 |
| 7. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 3 | 1 | 13 | 4 |
| 8. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 3 | 1 | 1 | 5 |
| 9. | Dusan Klinec ([@ph4r05](https://github.com/ph4r05)) | 3 | 1 | 1 | 1 |
| 10. | Zero King ([@l2dy](https://github.com/l2dy)) | 3 | 1 | 1 | 1 |
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Mar 2014 - Oct 2023 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Mar 2014 - May 2023 |
...
| 5. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | May 2017 - Jan 2021 |
| 6. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jun 2014 - May 2020 |
| 7. | Zero King ([@l2dy](https://github.com/l2dy)) | Mar 2020 - Mar 2020 |
| 8. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Sep 2018 |
| 9. | Dusan Klinec ([@ph4r05](https://github.com/ph4r05)) | Dec 2015 - Dec 2015 |
| 10. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Mar 2014 - Mar 2014 |
...
**Last edited by:** Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Zero King ([@l2dy](https://github.com/l2dy)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)).
