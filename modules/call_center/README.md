...
Each entity has a corresponding table in the database, for 
		...
		*cc_agents* tables, see
		[DB schema](https://web.opensips.org/docs/manual/1-11/install-dbschema#AEN2361).
...
#### b2b_scenario (string) {#param_b2b_scenario}
...
#### b2b_scenario_agent (string) {#param_b2b_scenario_agent}
