...
#### script_route_avp_result(string) {#param_script_route_avp_result}
...
| 4. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 3 | 1 | 6 | 6 |
...
| --- | --- | --- |
| 1. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | May 2024 - May 2024 |
| 2. | Dudu Ben Moshe | Feb 2024 - Feb 2024 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Feb 2021 - Oct 2023 |
| 4. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Feb 2023 - Feb 2023 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Aug 2022 - Aug 2022 |
...
**Last edited by:** Dudu Ben Moshe, Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), OpenSIPS.
## License
