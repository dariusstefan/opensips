...
#### dp_table (string) {#param_dp_table}
...
#### dp_col_rule (string) {#param_dp_col_rule}
...
#### dp_col_type (string) {#param_dp_col_type}
...
#### dp_col_att (string) {#param_dp_col_att}
...
#### dp_col_val (string) {#param_dp_col_val}
...
#### port_override_avp (string) {#param_port_override_avp}
...
#### transport_override_avp (string) {#param_transport_override_avp}
...
#### domain_replacement_avp (string) {#param_domain_replacement_avp}
...
#### domain_prefix_avp (string) {#param_domain_prefix_avp}
...
#### domain_suffix_avp (string) {#param_domain_suffix_avp}
...
#### send_socket_avp (string) {#param_send_socket_avp}
...
#### dp_can_connect() {#func_dp_can_connect}
...
#### dp_apply_policy() {#func_dp_apply_policy}
...
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 11 | 8 | 37 | 62 |
...
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 4 | 2 | 6 | 4 |
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Jun 2011 - Nov 2021 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Dec 2006 - Mar 2020 |
...
| 10. | Henning Westerholt ([@henningw](https://github.com/henningw)) | Jul 2007 - Jan 2008 |
...
**Last edited by:** Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert, Klaus Darilion.
