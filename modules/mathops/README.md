...
#### math_eval(expression, result_pvar) {#func_math_eval}
...
#### math_rpn(expression, result_pvar) {#func_math_rpn}
...
#### math_trunc(number, result_pvar) {#func_math_trunc}
...
#### math_floor(number, result_pvar) {#func_math_floor}
...
#### math_ceil(number, result_pvar) {#func_math_ceil}
...
#### math_round(number, result_pvar[, decimals]) {#func_math_round}
...
#### math_round_sf(number, result_pvar, figures) {#func_math_round_sf}
