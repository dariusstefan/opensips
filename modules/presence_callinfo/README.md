...
#### call_info_timeout_notification (int) {#param_call_info_timeout_notification}
...
**Example: Set call_info_timeout_notification parameter**
...
#### line_seize_timeout_notification (int) {#param_line_seize_timeout_notification}
...
**Example: Set line_seize_timeout_notification parameter**
...
#### disable_dialog_support_for_sca (int) {#param_disable_dialog_support_for_sca}
...
**Example: Set disable_dialog_support_for_sca parameter**
...
#### line_hash_size (int) {#param_line_hash_size}
...
**Example: Set line_hash_size parameter**
...
#### sca_set_calling_line([line]) {#func_sca_set_calling_line}
...
#### sca_set_called_line([line]) {#func_sca_set_called_line}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 21 | 8 | 1409 | 60 |
| 2. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | 12 | 6 | 577 | 7 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 10 | 8 | 22 | 14 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 9 | 7 | 42 | 52 |
| 5. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 7 | 4 | 45 | 67 |
| 6. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 6 | 4 | 5 | 6 |
| 7. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | 3 | 1 | 2 | 2 |
...
| --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Jan 2013 - Apr 2024 |
...
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Oct 2011 - Sep 2019 |
...
| 7. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | Mar 2014 - Mar 2014 |
| 8. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | Dec 2010 - Mar 2011 |
