...
**Example: Setting the db_table_routing parameter**
...
**Example: Setting the db_table_report parameter**
...
**Example: Setting the db_table_provider parameter**
...
**Example: Setting the proxy_role parameter**
...
**Example: Setting the url_vpc parameter**
...
**Example: Setting the emergency_codes parameter**
...
**Example: Setting the timer_interval parameter**
...
**Example: Setting the contingency_hostname parameter**
...
**Example: Setting the emergency_call_server parameter**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Evandro Villaron ([@evillaron](https://github.com/evillaron)) | 151 | 9 | 10947 | 3011 |
| 2. | Robison Tesini ([@rtesini](https://github.com/rtesini)) | 62 | 1 | 3116 | 2038 |
| 3. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 27 | 18 | 332 | 339 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 19 | 13 | 134 | 188 |
| 5. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 13 | 10 | 70 | 73 |
| 6. | Alexandra Titoc | 10 | 8 | 62 | 19 |
| 7. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 6 | 4 | 18 | 17 |
| 8. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 5 | 3 | 38 | 17 |
| 9. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | 4 | 2 | 4 | 4 |
| 10. | Zero King ([@l2dy](https://github.com/l2dy)) | 4 | 2 | 2 | 1 |


**All remaining contributors**: Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Julián Moreno Patiño, Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)).
...
| --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Jul 2015 - May 2026 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Mar 2015 - Apr 2026 |
| 3. | Alexandra Titoc | Sep 2024 - Sep 2024 |
| 4. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Jan 2021 - Nov 2023 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Mar 2015 - May 2023 |
| 6. | Walter Doekes ([@wdoekes](https://github.com/wdoekes)) | Apr 2021 - Apr 2021 |
| 7. | Zero King ([@l2dy](https://github.com/l2dy)) | Mar 2020 - Aug 2020 |
| 8. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Feb 2020 |
