...
In order to answer a SIP session carying MSRP the [init uas](#func_init_uas)
	...
	can use the [init uac](#func_init_uac) function.
...
MSRP SEND requests can be sent with the [send message](#func_send_message) function
...
| --- | --- | --- | --- | --- | --- |
| 1. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 55 | 16 | 4038 | 293 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 6 | 4 | 59 | 34 |
| 3. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 5 | 3 | 6 | 6 |
| 4. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 4 | 2 | 4 | 4 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 3 | 1 | 8 | 8 |
| 6. | Norman Brandinger ([@NormB](https://github.com/NormB)) | 3 | 1 | 2 | 2 |
...
| --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | May 2022 - Apr 2026 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Aug 2022 - Mar 2026 |
...
| 6. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | May 2022 - Jan 2023 |
| 7. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jul 2022 - Jul 2022 |
