...
**Example: Set my_node_id parameter**
...
**Example: Set sharing_tag parameter**
...
**Example: Set my_node_info parameter**
...
**Example: Set neighbor_node_info parameter**
...
**Example: Set ping_interval parameter**
...
**Example: Set ping_timeout parameter**
...
**Example: Set node_timeout parameter**
...
**Example: Set seed_fallback_interval parameter**
...
**Example: Set sync_timeout parameter**
...
**Example: Set sync_packet_size parameter**
...
**Example: Set dispatch_jobs parameter**
...
**Example: Set cluster_id_col parameter**
...
**Example: Set node_id_col parameter**
...
**Example: Set no_ping_retries_col parameter**
...
**Example: Set sip_addr_col parameter**
...
**Example: Set flags_col parameter**
...
**Example: Set description_col parameter**
...
**Example: Set enable_rerouting parameter**
...
#### cluster_broadcast_req(cluster_id, msg, [tag]) {#func_cluster_broadcast_req}
...
#### clusterer_reload {#mi_clusterer_reload}
...
#### clusterer_list {#mi_clusterer_list}
...
#### clusterer_list_topology {#mi_clusterer_list_topology}
...
#### clusterer_set_status {#mi_clusterer_set_status}
...
#### clusterer_remove_node {#mi_clusterer_remove_node}
...
#### cluster_send_mi {#mi_cluster_send_mi}
...
#### cluster_broadcast_mi {#mi_cluster_broadcast_mi}
...
#### clusterer_list_cap {#mi_clusterer_list_cap}
...
#### clusterer_set_cap_status {#mi_clusterer_set_cap_status}
...
#### clusterer_shtag_set_active {#mi_clusterer_shtag_set_active}
...
#### clusterer_list_shtags {#mi_clusterer_list_shtags}
...
For how to access and use the Status/Report information, please see
	[Status/Report Interface documentation](https://www.opensips.org/Documentation/Interface-StatusReport-3-4).
...
**Example: Example database content - clusterer table**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 364 | 135 | 13387 | 7101 |
| 2. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 72 | 54 | 868 | 585 |
| 3. | Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)) | 46 | 10 | 3142 | 534 |
| 4. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 32 | 17 | 1343 | 132 |
| 5. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 26 | 20 | 326 | 147 |
| 6. | Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)) | 9 | 2 | 250 | 212 |
| 7. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 8 | 6 | 12 | 13 |
| 8. | Jasper Hafkenscheid | 4 | 2 | 107 | 2 |
| 9. | Fabian Gast ([@fgast](https://github.com/fgast)) | 4 | 2 | 3 | 3 |
| 10. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 4 | 2 | 2 | 2 |


**All remaining contributors**: Gohar Ahmed ([@goharahmed](https://github.com/goharahmed)), kworm83, Shanee Vanstone.
...
| --- | --- | --- |
| 1. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Jul 2025 |
| 2. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Apr 2016 - Jun 2025 |
| 3. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Mar 2016 - Apr 2025 |
| 4. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Nov 2015 - Sep 2024 |
| 5. | Shanee Vanstone | Mar 2024 - Mar 2024 |
| 6. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Jan 2021 - Nov 2023 |
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | Jul 2016 - Jul 2023 |
| 8. | Jasper Hafkenscheid | May 2022 - Jul 2022 |
| 9. | kworm83 | Feb 2021 - Feb 2021 |
| 10. | Fabian Gast ([@fgast](https://github.com/fgast)) | Nov 2018 - Jul 2020 |


**All remaining contributors**: Gohar Ahmed ([@goharahmed](https://github.com/goharahmed)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)).
