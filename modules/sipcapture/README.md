...
#### report_capture([table_name],correlation_id[,proto_type]) {#func_report_capture}
...
#### hep_set([data_type,] chunk_id, [vendor_id,] chunk_data) {#func_hep_set}
...
#### hep_get([data_type,] chunk_id, vendor_id_pv, chunk_data_pv) {#func_hep_get}
