...
- *dialog* (only if **[use dialog](#use_dialog)** is enabled).
...
#### create_dialog_flags (string) {#create_dialog_flags}
...
#### sequential_route (string) {#sequential_route}
