...
The name of the Attribute-Value-Pair (AVP) used to store the URI
		...
		value of corresponding parameter in the [registrar](/modules/registrar)
...
> **Note:** You must set this parameter if you use [fix nated register](#func_fix_nated_register).
		...
		[received_avp](/modules/registrar#received_avp) module parameter
		to the **same value**.
...
The function creates a URI consisting of the source IP, port and
		...
		is also configured for the [registrar](/modules/registrar) module.
...
**Example: nathelper:enable_ping usage**
...
| --- | --- | --- | --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 158 | 124 | 2236 | 891 |
...
| 5. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 37 | 30 | 170 | 248 |
...
| --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Nov 2003 - Mar 2026 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Dec 2010 - Mar 2026 |
| 3. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jan 2013 - Nov 2024 |
| 4. | Alexandra Titoc | Sep 2024 - Sep 2024 |
| 5. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | May 2003 - Nov 2023 |
| 6. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | Aug 2010 - Jul 2023 |
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | May 2017 - Apr 2023 |
| 8. | Nick Altmann ([@nikbyte](https://github.com/nikbyte)) | May 2022 - May 2022 |
| 9. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Jun 2018 - Apr 2022 |
