...
#### sipping_bflag (string/integer) {#param_sipping_bflag}
...
#### remove_on_timeout_bflag (string/integer) {#param_remove_on_timeout_bflag}
...
#### sipping_latency_flag (string/integer) {#param_sipping_latency_flag}
