...
#### rtpproxy_tout (integer) {#param_rtpproxy_tout}
...
#### rtpproxy_engage([[flags][, [ip_address][, [set_id][, [sock_pvar][, ret_pvar]]]]]) {#func_rtpproxy_engage}
...
#### rtpproxy_offer([[flags][, [ip_address][, [set_id][, [sock_pvar][, ret_pvar]]]]) {#func_rtpproxy_offer}
...
#### rtpproxy_answer([[flags][, [ip_address][, [set_id][, [sock_pvar][, ret_pvar]]]]]) {#func_rtpproxy_answer}
...
#### rtpproxy_unforce([[set_id][, sock_pvar]]) {#func_rtpproxy_unforce}
...
#### rtpproxy_stream2uac(prompt_name, count[, [set_id][, sock_pvar]]), rtpproxy_stream2uas(prompt_name, count[, [set_id][, sock_pvar]]) {#rtpproxy_stream2xxx}
...
#### rtpproxy_stop_stream2uac([[set_id][, sock_pvar]]), rtpproxy_stop_stream2uas([[set_id][, sock_pvar]]) {#rtpproxy_stop_stream2xxx}
...
#### rtpproxy_start_recording([[set_id][, [sock_pvar][, [flags][, [destination][, mediastream]]]]]) {#func_rtpproxy_start_recording}
...
#### rtpproxy_stats(up_pvar, down_pvar, sent_pvar, fail_pvar[, [set_id][, sock_pvar]]) {#func_rtpproxy_stats}
...
#### rtpproxy_all_stats(stats_avp[, [set_id][, sock_pvar]]) {#func_rtpproxy_all_stats}
