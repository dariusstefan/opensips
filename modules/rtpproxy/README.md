...
#### rtpproxy_sock (string) {#param_rtpproxy_sock}
...
#### rtpproxy_disable_tout (integer) {#param_rtpproxy_disable_tout}
...
#### rtpproxy_timeout (string) {#param_rtpproxy_timeout}
...
#### rtpproxy_autobridge (integer) {#param_rtpproxy_autobridge}
...
**Example: Enable auto-bridging feature**
...
#### rtpproxy_retr (integer) {#param_rtpproxy_retr}
...
#### default_set (integer) {#param_default_set}
...
#### rtpp_socket_col (string) {#param_rtpp_socket_col}
...
#### set_id_col (string) {#param_set_id_col}
...
#### rtpp_notify_socket (string) {#param_rtpp_notify_socket}
...
#### generated_sdp_port_min (integer) {#param_generated_sdp_port_min}
...
#### generated_sdp_port_max (integer) {#param_generated_sdp_port_max}
...
#### generated_sdp_media_ip (string) {#param_generated_sdp_media_ip}
...
#### rtpproxy_engage([[flags][, [ip_address][, [set_id][, [sock_var][, ret_var]]]]]) {#func_rtpproxy_engage}
...
#### rtpproxy_offer([[flags][, [ip_address][, [set_id][, [sock_var][, [ret_var][, [body_var][, [bind_local]]]]]]]]) {#func_rtpproxy_offer}
...
#### rtpproxy_answer([[flags][, [ip_address][, [set_id][, [sock_var][, [ret_var][, [body_var][, [bind_local]]]]]]]]) {#func_rtpproxy_answer}
...
#### rtpproxy_unforce([[set_id][, sock_var]]) {#func_rtpproxy_unforce}
...
#### rtpproxy_start_recording([[set_id][, [sock_var][, [flags][, [destination][, mediastream]]]]]) {#func_rtpproxy_start_recording}
...
#### rtpproxy_stats(up_pvar, down_var, sent_var, fail_var[, [set_id][, sock_var]]) {#func_rtpproxy_stats}
...
#### rtpproxy_all_stats(stats_avp[, [set_id][, sock_var]]) {#func_rtpproxy_all_stats}
...
#### E_RTPPROXY_STATUS {#event_E_RTPPROXY_STATUS}
...
#### E_RTPPROXY_DTMF {#event_E_RTPPROXY_DTMF}
...
| --- | --- | --- | --- | --- | --- |
| 1. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | 274 | 171 | 6298 | 2998 |
| 2. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | 69 | 17 | 5336 | 367 |
| 3. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | 31 | 26 | 174 | 139 |
| 4. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | 30 | 23 | 229 | 244 |
| 5. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | 26 | 9 | 409 | 725 |
| 6. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | 7 | 5 | 60 | 59 |
| 7. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | 7 | 5 | 31 | 22 |
| 8. | Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)) | 6 | 4 | 15 | 9 |
| 9. | Ryan Bullock ([@rrb3942](https://github.com/rrb3942)) | 4 | 2 | 68 | 9 |
| 10. | John Burke ([@john08burke](https://github.com/john08burke)) | 4 | 2 | 8 | 6 |


**All remaining contributors**: robdyck, Dave Sidwell ([@davesidwell](https://github.com/davesidwell)), Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Danielzt, Christophe Sollet ([@csollet](https://github.com/csollet)), Anca Vamanu, Mikko Lehto, Dan Pascu ([@danpascu](https://github.com/danpascu)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Julián Moreno Patiño, Norman Brandinger ([@NormB](https://github.com/NormB)), Zero King ([@l2dy](https://github.com/l2dy)).
...
| --- | --- | --- |
| 1. | Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)) | Mar 2011 - Apr 2026 |
| 2. | Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)) | Mar 2011 - Apr 2026 |
| 3. | Danielzt | Apr 2026 - Apr 2026 |
| 4. | Maksym Sobolyev ([@sobomax](https://github.com/sobomax)) | Mar 2011 - Jun 2025 |
| 5. | Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)) | Jul 2012 - Apr 2025 |
| 6. | Norman Brandinger ([@NormB](https://github.com/NormB)) | Jun 2024 - Jun 2024 |
| 7. | Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)) | May 2017 - Mar 2023 |
| 8. | Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)) | Dec 2011 - Apr 2022 |
| 9. | John Burke ([@john08burke](https://github.com/john08burke)) | Apr 2021 - Apr 2021 |
| 10. | Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)) | Mar 2011 - Jun 2020 |


**All remaining contributors**: robdyck, Zero King ([@l2dy](https://github.com/l2dy)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Julián Moreno Patiño, Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Dave Sidwell ([@davesidwell](https://github.com/davesidwell)), Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Mikko Lehto, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Christophe Sollet ([@csollet](https://github.com/csollet)), Anca Vamanu.
...
**Last edited by:** Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Zero King ([@l2dy](https://github.com/l2dy)), Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Julián Moreno Patiño, Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), Mikko Lehto, Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)).
