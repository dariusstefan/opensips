...
#### rtpproxy_stream2uac(prompt_name, count), rtpproxy_stream2uas(prompt_name, count) {#rtpproxy_stream2xxx}
...
#### rtpproxy_stop_stream2uac(), rtpproxy_stop_stream2uas() {#rtpproxy_stop_stream2xxx}
