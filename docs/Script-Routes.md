...
A route can return a set of values, that can later be retrieved from the route's calling context using the [`$return`](https://web.opensips.org/docs/manual/3-6/script-corevar#return) variable.
