...
In order to listen for incoming Binary Packets, a **bin:** interface must be specified.  Its number of listener processes can be tuned with *[tcp_children](https://web.opensips.org/docs/manual/2-4/script-coreparameters#toc66)* (default: 8)
