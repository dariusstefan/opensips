...
More details can be found in the [dialog](https://www.opensips.org/html/docs/modules/4.0.x/dialog#dialog-clustering) and [usrloc](https://www.opensips.org/html/docs/modules/4.0.x/usrloc#distributed-sip-user-location) documentation pages.
