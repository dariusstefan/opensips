...
In order to listen for incoming Binary Packets, a **bin:** interface must be specified.  Its number of listener processes can be tuned with *[tcp_children](https://web.opensips.org/docs/manual/2-3/script-coreparameters#toc92)* (default: 8)
...
More details can be found in the [dialog](../modules/dialog/README.md#idp3487424) and [usrloc](../modules/usrloc/README.md#usrloc-replication) documentation pages.
