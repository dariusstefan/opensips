...
In order to listen for incoming Binary Packets, a **bin:** interface must be specified.  Its number of listener processes can be tuned with *[tcp_children](https://web.opensips.org/docs/manual/2-2/script-coreparameters#toc92)* (default: 8)
