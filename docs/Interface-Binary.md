...
In order to listen for incoming Binary Packets, a **bin:** interface must be specified.  Its number of listener processes can be tuned with *[tcp_children](https://web.opensips.org/docs/manual/3-0/script-coreparameters#toc65)* (default: 8)
