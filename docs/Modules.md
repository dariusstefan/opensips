...
| [**FRAUD_DETECTION**](../modules/fraud_detection/README.md) | Detects fraudulent calls | beta / @@red|NEW@@ |
...
| [**PROTO_WS**](../modules/proto_ws/README.md) | WebSocket protocol module - implements WS transport for SIP | beta / @@red|NEW@@ |
...
| [**RTPENGINE**](../modules/rtpengine/README.md) | Connector to RTPengine external RTP relay | beta / @@red|NEW@@ |
...
| [**TOPOLOGY_HIDING**](../modules/topology_hiding/README.md) | Provides Topology Hiding capabilities | beta / @@red|NEW@@ |
...
| [**CLOSEDDIAL**](../modules/closeddial/README.md) | PBX-like dialling features | @@red|unmaintained@@ / @@green|stable@@ |
| [**MI_XMLRPC**](../modules/mi_xmlrpc/README.md) | XMLRPC support for Management Interface | @@red|unmaintained@@ / @@green|stable@@ |
