...
| [**AUTH_DIAMETER**](../modules/auth_diameter/README.md) | DIAMETER-backend authentication module | @@red|unmaintained@@ |
| [**AVPOPS**](../modules/avpops/README.md) | AVP operation module | @@green|stable@@ |
| [**BENCHMARK**](../modules/benchmark/README.md) | Config file benchmarking | @@green|stable@@ |
...
| [**CACHEDB_CASSANDRA**](../modules/cachedb_cassandra/README.md) | Cassandra Implementation of CacheDB | beta / @@red|NEW@@ |
...
| [**CACHEDB_REDIS**](../modules/cachedb_redis/README.md) | Redis Implementation of CacheDB | beta / @@red|NEW@@ |
...
| [**CFGUTILS**](../modules/cfgutils/README.md) | Different config utilities | @@green|stable@@ |
| [**CLOSEDDIAL**](../modules/closeddial/README.md) | PBX-like dialing features | @@green|stable@@ |
| [**CPL-C**](../modules/cpl-c/README.md) | CPL interpreter module | @@green|stable@@ |
...
| [**DNS_CACHE**](../modules/dns_cache/README.md) | Module for caching DNS records that can be used with any Key-Value back-end | beta / @@red|NEW@@ |
...
| [**EVENT_DATAGRAM**](../modules/event_datagram/README.md) | Event datagram module | @@green|stable@@ |
| [**EVENT_RABBITMQ**](../modules/event_rabbitmq/README.md) | Event RabbitMQ client module | beta / @@red|NEW@@ |
...
| [**HTTPD**](../modules/httpd/README.md) | Embedded HTTP server | beta / @@red|NEW@@ |
...
| [**JSON**](../modules/json/README.md) | JSON packing function | @@green|stable@@ |
...
| [**LUA**](../modules/lua/README.md) | Call LUA scripts from OpenSIPS cfg | beta / @@red|NEW@@ |
...
| [**MI_HTTP**](../modules/mi_http/README.md) | HTTP support for Management Interface | alpha / @@red|NEW@@ |
| [**MI_XMLRPC**](../modules/mi_xmlrpc/README.md) | XMLRPC support for Management Interface | @@green|stable@@ |
...
| [**PDT**](../modules/pdt/README.md) | Prefix-to-Domain translator module | @@green|stable@@ |
...
| [**PERLVDB**](../modules/perlvdb/README.md) | Perl Virtual Database engine | @@green|stable@@ |
...
| [**RTPPROXY**](../modules/rtpproxy/README.md) | NAT traversal using RTPProxy module | @@green|stable@@ |
...
| [**SIPCAPTURE**](../modules/sipcapture/README.md) | SipCapture module | alpha / @@red|NEW@@ |
| [**SIPMSGOPS**](../modules/sipmsgops/README.md) | SIP operations module | @@green|stable@@ |
| [**SIPTRACE**](../modules/siptrace/README.md) | SipTrace module | @@green|stable@@ |
| [**SL**](../modules/sl/README.md) | Stateless replier module | @@green|stable@@ |
| [**SMS**](../modules/sms/README.md) | SIP-to-SMS IM gateway module | @@green|stable@@ |
...
| [**TLSOPS**](../modules/tlsops/README.md) | TLS operations module | @@green|stable@@ |
...
| [**URI**](../modules/uri/README.md) | Generic URI operation module | @@green|stable@@ |
