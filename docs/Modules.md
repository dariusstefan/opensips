...
* [**MQUEUE**](../modules/mqueue/README.md) - Message queue system inter-process communication using the config file, @@green|stable@@
...
* [**PROTO_MSRP**](../modules/proto_msrp/README.md) - implements MSRP protocol stack, @@green|stable@@
