...
Only relevant when [log_stderror](https://web.opensips.org/docs/manual/1-10/script-coreparameters#toc61) is set to *true*. Enables the use of the [color escape sequences](https://web.opensips.org/docs/manual/1-10/script-corevar#toc97), otherwise they will have no effect.
