...
Only relevant when [log_stderror](https://web.opensips.org/docs/manual/1-8/script-coreparameters#toc57) is set to *true*. Enables the use of the [color escape sequences](https://web.opensips.org/docs/manual/1-8/script-corevar#toc94), otherwise they will have no effect.
