...
Default level for printing the logs generated by [xlog](https://web.opensips.org/docs/manual/3-4/script-corefunctions#xlog) core function, when the log_level parameter is omitted.
