...
Only relevant when [log_stderror](https://web.opensips.org/docs/manual/1-9/script-coreparameters#toc59) is set to *true*. Enables the use of the [color escape sequences](https://web.opensips.org/docs/manual/1-9/script-corevar#toc97), otherwise they will have no effect.
