...
The [status_report](https://opensips.org/docs/modules/3.3.x/status_report.html) allow the creation of custom SR identifiers from script level. Even more, it is possible to set the status or to publish a report from script for such custom identifiers.
