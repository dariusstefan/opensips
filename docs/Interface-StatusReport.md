...
The SR Interface provides a script function to check the readiness status of an identifier (or of an entire group), see the [sr_check_status( group, \[identifier\])](https://web.opensips.org/docs/manual/3-5/script-corefunctions#sr_check_status) function.
...
* [sr_get_status](https://web.opensips.org/docs/manual/3-5/interface-coremi#sr_get_status)
* [sr_list_status](https://web.opensips.org/docs/manual/3-5/interface-coremi#sr_list_status)
* [sr_list_reports](https://web.opensips.org/docs/manual/3-5/interface-coremi#sr_list_reports)
* [sr_list_identifiers](https://web.opensips.org/docs/manual/3-5/interface-coremi#sr_list_identifiers)

---

## Events {#code_identifiers}

The SR framework raises an event each time the status of a Status/Report identifier changes. See the [E_CORE_SR_STATUS_CHANGED event](https://web.opensips.org/docs/manual/3-5/interface-coreevents#E_CORE_SR_STATUS_CHANGED) for more details.
