...
### Forced socket @@red|(Obsoleted with OpenSIPS 3.2)@@ - $fs {#fs}
...
### Protocol of received message {#proto}
...
### Received IP address @@red|(Obsoleted with OpenSIPS 3.2)@@ - $Ri {#Ri}

Use [`$socket_in(ip)`](#socket_in) instead.

### Received port @@red|(Obsoleted with OpenSIPS 3.2)@@ - $Rp {#Rp}
