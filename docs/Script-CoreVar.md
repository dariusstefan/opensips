...
@@anchor|msg.branch.last_idx@@
### Index of the last message branch - $msg.branch.last_idx [🔗](#msg.branch.last_idx)
...
@@anchor|proxy_protocol@@
### Proxy Protocol from transport layer - $proxy_protocol [🔗](#proxy_protocol)
