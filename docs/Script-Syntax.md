...
* *string* (unlimited size)
  * note that some functions which use strings may have internal buffers which limit the maximum size of the strings (e.g. the [xlog()](https://www.opensips.org/Documentation/Script-CoreFunctions-3-3#toc54) function's output buffer is configurable via [xlog_buf_size](https://www.opensips.org/Documentation/Script-CoreParameters-3-3#toc96))
* *double* (packed as string), through the **[mathops](https://opensips.org/docs/modules/3.3.x/mathops.html)** module
