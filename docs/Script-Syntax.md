...
All OpenSIPS [core](https://web.opensips.org/docs/manual/3-3/script-corefunctions) and [module](https://web.opensips.org/docs/manual/3-3/function-index) functions internally share the same function interface, such that they benefit from the following calling convention:
