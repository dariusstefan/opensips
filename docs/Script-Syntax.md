...
* *double* (packed as string), through the **[mathops](https://opensips.org/docs/modules/3.6.x/mathops.html)** module

### Complex

* *list* via the **[`$avp` variable](https://www.opensips.org/Documentation/Script-CoreVar-3-6#toc2)**
* *map* via the **[`$json`](https://opensips.org/docs/modules/3.6.x/json.html#pv_json)** and **[`$xml`](https://opensips.org/docs/modules/3.6.x/xml.html#pv_xml)** variables
