...
More complex examples can be found in the [Key-Value Interface Tutorial](https://web.opensips.org/docs/tutorials-memorycaching).
...
This function fetches from a memory-cache-like-storage system the value of an attribute. The attribute name may contain pseudo-variables. The result (if any) will be stored in the **result_avp** [AVP variable](Script-CoreVar.md#toc2). 
