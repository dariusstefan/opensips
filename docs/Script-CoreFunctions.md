...
## add_local_rport()  [🔗](#add_local_rport) {#add_local_rport}
...
## assert(statement, [description])  [🔗](#assert) {#assert}

Only works if [enable_asserts](http://www.opensips.org/Documentation/Script-CoreParameters-4-0#toc53) is set to *true*. If the given expression evaluates to *false*, script execution is stopped and the [error_route](http://www.opensips.org/Documentation/Script-Routes-4-0#toc5) is executed. If [abort_on_assert](http://www.opensips.org/Documentation/Script-CoreParameters-4-0#toc24) is enabled, OpenSIPS will also shutdown.
...
## append_branch([uri], [qvalue])  [🔗](#append_branch) {#append_branch}
...
## append_msg_branch(uri, [qvalue], [flags])  [🔗](#append_msg_branch) {#append_msg_branch}
...
## avp_print()  [🔗](#avp_print) {#avp_print}

Prints the list with all the AVPs from memory. This is only a helper/debug function. 

## cache_store(storage_id, attribute, value, [timeout])  [🔗](#cache_store) {#cache_store}
...
## cache_remove(storage_id, attribute)  [🔗](#cache_remove) {#cache_remove}
...
## cache_fetch(storage_id, attribute, result)  [🔗](#cache_fetch) {#cache_fetch}
...
## cache_counter_fetch(storage_id, counter_attribute, result)  [🔗](#cache_counter_fetch) {#cache_counter_fetch}
...
## cache_add( storage_id, attribute, increment, expire, [new_val])  [🔗](#cache_add) {#cache_add}
...
## cache_sub(storage_id, attribute, decrement, expire, [new_val])  [🔗](#cache_sub) {#cache_sub}
...
## cache_raw_query(storage_id, raw_query, result)  [🔗](#cache_raw_query) {#cache_raw_query}
...
## construct_uri(proto,[user],domain,[port],[extra],result)  [🔗](#construct_uri) {#construct_uri}
...
## force_rport()  [🔗](#force_rport) {#force_rport}
...
## force_send_socket(proto:address[:port])  [🔗](#force_send_socket) {#force_send_socket}
...
## force_tcp_alias([port_alias])       [🔗](#force_tcp_alias) {#force_tcp_alias}
...
## forward(destination)  [🔗](#forward) {#forward}
...
## get_timestamp(sec_avp,usec_avp)  [🔗](#get_timestamp) {#get_timestamp}
...
## isdsturiset()  [🔗](#isdsturiset) {#isdsturiset}
...
## isflagset(string)  [🔗](#isflagset) {#isflagset}
...
## isbflagset(flag, [branch_idx])  [🔗](#isbflagset) {#isbflagset}
...
## is_myself(host, [port])  [🔗](#is_myself) {#is_myself}
...
## move_branch([src_idx], [dst_idx] [, keep])  [🔗](#move_branch) {#move_branch}
...
## next_branches()  [🔗](#next_branches) {#next_branches}
...
## pv_printf(pv, fmt_str)  [🔗](#pv_printf) {#pv_printf}
...
## raise_event(event, [attrs], [vals])  [🔗](#raise_event) {#raise_event}
...
## remove_msg_branch(branch_idx)  [🔗](#remove_msg_branch) {#remove_msg_branch}
...
## resetdsturi()  [🔗](#resetdsturi) {#resetdsturi}
...
## resetflag(flag)  [🔗](#resetflag) {#resetflag}
...
## resetbflag(flag, [branch_idx])  [🔗](#resetbflag) {#resetbflag}
...
## revert_uri()  [🔗](#revert_uri) {#revert_uri}
...
## set_via_handling(flags)  [🔗](#set_via_handling) {#set_via_handling}
...
## sethostport(hostport)  [🔗](#sethostport) {#sethostport}
...
## setuserpass(pass)  [🔗](#setuserpass) {#setuserpass}
...
## send(destination [, headers])  [🔗](#send) {#send}
...
## serialize_branches(clear_previous[, keep_order])  [🔗](#serialize_branches) {#serialize_branches}
...
## set_advertised_address(adv_addr)  [🔗](#set_advertised_address) {#set_advertised_address}
...
## set_advertised_port(adv_port)  [🔗](#set_advertised_port) {#set_advertised_port}
...
## setdsturi(uri)  [🔗](#setdsturi) {#setdsturi}
...
## setbflag(flag, [branch_idx])  [🔗](#setbflag) {#setbflag}
...
## socket_belongs_to_bond( socket, bond)  [🔗](#socket_belongs_to_bond) {#socket_belongs_to_bond}
...
## sr_check_status( group, [identifier]) [🔗](#sr_check_status) {#sr_check_status}
...
## strip_tail(n)  [🔗](#strip_tail) {#strip_tail}
...
## subscribe_event(string, string [, int])  [🔗](#subscribe_event) {#subscribe_event}
...
## swap_branches([br1_idx], [br2_idx])  [🔗](#swap_branches) {#swap_branches}
...
## use_blacklist(bl_name)  [🔗](#use_blacklist) {#use_blacklist}
...
## unuse_blacklist(bl_name)  [🔗](#unuse_blacklist) {#unuse_blacklist}
...
## check_blacklist_rule([bl_name], ip[, port [, proto]]) [🔗](#check_blacklist_rule) {#check_blacklist_rule}
...
## add_blacklist_rule([bl_name], ip[, port [, proto [, expire]]]) [🔗](#add_blacklist_rule) {#add_blacklist_rule}
...
## del_blacklist_rule([bl_name], ip[, port [, proto]]) [🔗](#del_blacklist_rule) {#del_blacklist_rule}
...
## xlog([log_level, ]format_string)  [🔗](#xlog) {#xlog}
