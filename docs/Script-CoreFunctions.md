...
@@anchor|append_msg_branch@@
## append_msg_branch(uri, [qvalue], [flags])  [🔗](#append_msg_branch)
...
@@anchor|cache_store@@
## cache_store(storage_id, attribute, value, [timeout])  [🔗](#cache_store)
...
@@anchor|cache_add@@
## cache_add( storage_id, attribute, increment, expire, [new_val])  [🔗](#cache_add)
...
@@anchor|construct_uri@@
## construct_uri(proto,[user],domain,[port],[extra],result)  [🔗](#construct_uri)
...
@@anchor|force_send_socket@@
## force_send_socket(proto:address[:port])  [🔗](#force_send_socket)
...
@@anchor|force_tcp_alias@@
## force_tcp_alias([port_alias])       [🔗](#force_tcp_alias)
...
## get_timestamp(sec_avp,usec_avp)  [🔗](#get_timestamp)
...
@@anchor|isbflagset@@
## isbflagset(flag, [branch_idx])  [🔗](#isbflagset)
...
@@anchor|move_branch@@
## move_branch([src_idx], [dst_idx] [, keep])  [🔗](#move_branch)
...
@@anchor|pv_printf@@
## pv_printf(pv, fmt_str)  [🔗](#pv_printf)
...
@@anchor|raise_event@@
@@anchor|raise_event@@
## raise_event(event, [attrs], [vals])  [🔗](#raise_event)
...
@@anchor|remove_msg_branch@@
## remove_msg_branch(branch_idx)  [🔗](#remove_msg_branch)
...
@@anchor|resetbflag@@
## resetbflag(flag, [branch_idx])  [🔗](#resetbflag)
...
@@anchor|set_via_handling@@
## set_via_handling(flags)  [🔗](#set_via_handling)
...
@@anchor|sethostport@@
## sethostport(hostport)  [🔗](#sethostport)
...
@@anchor|serialize_branches@@
## serialize_branches(clear_previous[, keep_order])  [🔗](#serialize_branches)
...
@@anchor|set_advertised_address@@
## set_advertised_address(adv_addr)  [🔗](#set_advertised_address)
...
@@anchor|set_advertised_port@@
## set_advertised_port(adv_port)  [🔗](#set_advertised_port)
...
@@anchor|setbflag@@
## setbflag(flag, [branch_idx])  [🔗](#setbflag)
...
@@anchor|socket_belongs_to_bond@@
## socket_belongs_to_bond( socket, bond)  [🔗](#socket_belongs_to_bond)
...
@@anchor|sr_check_status@@
## sr_check_status( group, [identifier]) [🔗](#sr_check_status)
...
@@anchor|subscribe_event@@
@@anchor|subscribe_event@@
## subscribe_event(string, string [, int])  [🔗](#subscribe_event)
...
@@anchor|swap_branches@@
## swap_branches([br1_idx], [br2_idx])  [🔗](#swap_branches)
...
@@anchor|use_blacklist@@
## use_blacklist(bl_name)  [🔗](#use_blacklist)
...
@@anchor|unuse_blacklist@@
## unuse_blacklist(bl_name)  [🔗](#unuse_blacklist)
...
@@anchor|check_blacklist_rule@@
## check_blacklist_rule([bl_name], ip[, port [, proto]]) [🔗](#check_blacklist_rule)
...
## add_blacklist_rule([bl_name], ip[, port [, proto [, expire]]]) [🔗](#add_blacklist_rule)
...
## del_blacklist_rule([bl_name], ip[, port [, proto]]) [🔗](#del_blacklist_rule)
...
@@anchor|xlog@@
## xlog([log_level, ]format_string)  [🔗](#xlog)
