...
```
*Note that resume_route must be a **[simple route](https://web.opensips.org/docs/manual/3-4/script-routes#toc1)***.
...
```
*Note that report_route must be a **[simple route](https://web.opensips.org/docs/manual/3-4/script-routes#toc1)***.
