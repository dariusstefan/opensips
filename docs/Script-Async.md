...
```
*Note that resume_route has to be a **[simple route](https://web.opensips.org/docs/manual/2-4/script-routes#toc1)***.
...
```
*Note that report_route has to be a **[simple route](https://web.opensips.org/docs/manual/2-4/script-routes#toc1)***.
