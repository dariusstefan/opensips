...
```
*Note that resume_route must be a **[simple route](https://web.opensips.org/docs/manual/devel/script-routes)***.
...
```
*Note that report_route must be a **[simple route](https://web.opensips.org/docs/manual/devel/script-routes)***.
