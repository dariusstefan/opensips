...
```
*Note that resume_route must be a **[simple route](https://web.opensips.org/docs/manual/3-3/script-routes)***.
...
```
*Note that report_route must be a **[simple route](https://web.opensips.org/docs/manual/3-3/script-routes)***.
