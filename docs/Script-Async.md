...
```
*Note that resume_route must be a **[simple route](http://www.opensips.org/Documentation/Script-Routes-3-4#toc1)***.
...
```
*Note that report_route must be a **[simple route](http://www.opensips.org/Documentation/Script-Routes-3-4#toc1)***.
