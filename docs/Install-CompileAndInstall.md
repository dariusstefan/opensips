...
description: "The following page of the manual is addressed to users that want to compile and install OpenSIPS 3.6 from sources. :::tip If you have download an OpenSIPS pa..."
---
