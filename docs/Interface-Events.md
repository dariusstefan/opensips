...
More detailed information about **OpenSIPS Event Interface** can be found in the [Event Interface Tutorial](https://web.opensips.org/docs/tutorials-eventinterface-1-8).
...
You can subscribe for an event either at startup (using the [subscribe_event()](https://web.opensips.org/docs/manual/1-9/script-corefunctions#subscribe_event) command in the script) or during runtime, using the [event_subscribe](Interface-CoreMI.md#event_subscribe) MI command.
