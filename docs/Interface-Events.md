...
* [event_datagram](http://www.opensips.org/html/docs/modules/3.5.x/event_datagram) - sends Datagrams over UDP or UNIX sockets
* [event_flastore](http://www.opensips.org/html/docs/modules/3.5.x/event_flatstore) - writes to plain text files
* [event_kafka](http://www.opensips.org/html/docs/modules/3.5.x/event_kafka) - sends events via Apache Kafka broker
* [event_rabbitmq](http://www.opensips.org/html/docs/modules/3.5.x/event_rabbitmq) - sends an AMQP message to a RabbitMQ server
* [event_route](http://www.opensips.org/html/docs/modules/3.5.x/event_route) - runs an OpenSIPS event_route in script
* [event_stream](http://www.opensips.org/html/docs/modules/3.5.x/event_stream) - sends a JSON-RPC command/notification over TCP
* [event_virtual](http://www.opensips.org/html/docs/modules/3.5.x/event_virtual) - aggregates event backends for failover and balancing
* [event_xmlrpc](http://www.opensips.org/html/docs/modules/3.5.x/event_xmlrpc) - sends a XML-RPC command over TCP
