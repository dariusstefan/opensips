...
This event is triggered whenever a new process is created (forked) or a process is terminated due the auto-scaling logic. In order to have this event trigger, the [auto-scaling](https://web.opensips.org/docs/manual/3-5/script-coreparameters#auto_scaling_profile) must be enabled in your configuration.
