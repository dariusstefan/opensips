...
[- Page for other versions: [devel](Install-Download.md) [1.9](https://web.opensips.org/docs/manual/1-9/install-download) 1.8 old versions: [1.7](https://web.opensips.org/docs/manual/1-7/install-download) [1.6](https://web.opensips.org/docs/manual/1-6/install-download) [1.5](https://web.opensips.org/docs/manual/1-5/install-download) [1.4](https://web.opensips.org/docs/manual/1-4/install-download) -]
