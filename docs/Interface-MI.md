...
The **MI** commands are provided by the OpenSIPS core (see [full list](https://web.opensips.org/docs/manual/1-6/interface-coremi)) and also by modules (check the commands provided by [each module](https://web.opensips.org/docs/manual/1-6/modules)).
