...
* *rule* - a string containing a blacklist rule, according to [**dst_blacklist**](https://web.opensips.org/docs/manual/3-5/script-coreparameters#dst_blacklist) parameter
...
The MI equivalent of the [sr_check_status() script function](https://web.opensips.org/docs/manual/3-5/script-corefunctions#sr_check_status) - to get the status of an 'status/report' identifier/group.

**Arguments**: a mandatory *group* and optional *identifier*, see the parameters of the [sr_check_status() script function](https://web.opensips.org/docs/manual/3-5/script-corefunctions#sr_check_status).
**Output**: the readiness, the status and details of the identifier/group (see the aggregation note for the return code of the [sr_check_status() script function](https://web.opensips.org/docs/manual/3-5/script-corefunctions#sr_check_status)
...
**Arguments**: an optional 'status/report'  *group*, see the [sr_check_status() script function](https://web.opensips.org/docs/manual/3-5/script-corefunctions#sr_check_status) for more details.
...
**Arguments**:
* an optional 'status/report'  *group*, see the [sr_check_status() script function](https://web.opensips.org/docs/manual/3-5/script-corefunctions#sr_check_status) for more details. If missing, all the groups will be listed.
